...
//        System.out.println(StringUtils.isPalindrome(null));
        ...
        System.out.println(StringUtils.combineStringsWithSum("11", "9"));
        System.out.println(StringUtils.combineStringsWithSum("99", "99"));
        System.out.println(StringUtils.combineStringsWithSum("99", "999"));
        System.out.println(StringUtils.combineStringsWithSum("99", ""));
    }
}
